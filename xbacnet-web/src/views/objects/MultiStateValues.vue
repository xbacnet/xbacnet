<template>
  <div class="analog-inputs">
    ...
    <div class="page-header">
      <h1>Multi-state Value Objects</h1>
      <p>Manage multi-state value objects in the BACnet system</p>
    </div>
...
const dialogTitle = computed(() => {
  return isEdit.value ? 'Edit Multi-state Value' : 'Create Multi-state Value'
})
