<template>
  <div class="analog-inputs">
    ...
    <div class="page-header">
      <h1>Multi-state Input Objects</h1>
      <p>Manage multi-state input objects in the BACnet system</p>
    </div>
...
const dialogTitle = computed(() => {
  return isEdit.value ? 'Edit Multi-state Input' : 'Create Multi-state Input'
})
